...
class Auth_AD
{
    ...
    public function login($username, $password) {
        ...
        if ($continue) {
            ...
            $user_info = array(
                ...
                'physicaldeliveryofficename' => $entries['physicaldeliveryofficename'][0],
                'is_admin' => $is_admin,
        ...
        if (strlen($username) > 0 && strlen($password) > 0) {
            ...
            if ($continue) {
                ...
                if (!$return = $this -> search_ad($username, array(
                    ...
                    // User doesn't exist!
                    log_message('debug', 'Auth_AD: User doesnt exist!.');
                    $continue = false;
                }
            }
    ...
    public function auto_search($username){
            // preset the return marker
            $return = false;
