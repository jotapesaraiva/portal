               ...
               <div class="portlet light bordered">
                   <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Evolutiva por mês / nome </span>
                    </div>
                   </div>
                        ...
                        <form method="post" action="<?php $_SERVER['PHP_SELF']?>">
                          <div class="col-md-3 col-md-offset-3">
                            <label class="control-label col-md-4 bold">Data Inicio </label>
                              <div class="input-group input-medium date month-picker" >
...
<!-- /* Location: ./application/views/mantis/cgps/evolutiva.php */ -->