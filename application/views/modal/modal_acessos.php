<!-- Bootstrap modal -->
<div class="modal fade" id="modal_acesso" role="dialog">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nome" placeholder="Nome do acesso" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="responsavel" placeholder="Responsável" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
