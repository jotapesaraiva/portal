               ...
               <div class="portlet light bordered">
                   <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Fitas Library - Cofre Grandes Contribuintes  </span>
                    </div>
                   </div>
                ...
                <div id="msgs"></div>
                 ...
                 <div class="portlet light bordered">
                     <div class="portlet-title">
                      <div class="caption font-dark">
                          <i class="icon-settings font-dark"></i>
                          <span class="caption-subject bold uppercase"> Cofre Grandes Contribuintes - Library </span>
                      </div>
                     </div>
                     <div class="portlet-body">
                      <div class="table-toolbar">
