                ...
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase"> Backup de Banco de dados </span>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                         ...
                                         <?php echo anchor('banco_de_dados/backup/manual/default','Realizar backup manual <i class="fa fa-plus"></i>','id="reload_table" class="btn sbold green"');?>
                                    </div>
                                </div>
                                <div class="col-md-6">
