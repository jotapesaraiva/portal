  ...
  $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            url : origin+"/categoria_voip_list",//json datasource
  ...
  function edit_person(id) {
      ...
      $.ajax({
          url : origin+"/categoria_voip_edit/" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
              $('[name="id"]').val(data.id_tipo_categoria_voip);
              $('[name="nome"]').val(data.nome_tipo_categoria_voip);
              $('[name="comentario"]').val(data.comentario_tipo_categoria_voip);
  ...
  function save(){
      ...
      if(save_method == 'add') {
          ...
          url = origin+"/categoria_voip_add";
      } else {
          url = origin+"/categoria_voip_update";
      }
  ...
  function delete_person(id){
      if(confirm('Você tem certeza que quer deletar o item?')) {
          ...
          $.ajax({
              url : origin+"/categoria_voip_delete/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
