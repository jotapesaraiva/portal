  ...
  $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/categoria_voip_list",//json datasource
  ...
  function edit_person(id) {
      ...
      $.ajax({
          url : href+"/categoria_voip_edit/" + id,
          type: "GET",
          dataType: "JSON",
  ...
  function save(){
      ...
      if(save_method == 'add') {
          ...
          url = href+"/categoria_voip_add";
      } else {
          url = href+"/categoria_voip_update";
      }
  ...
  function delete_person(id){
      if(confirm('Você tem certeza que quer deletar o item?')) {
          ...
          $.ajax({
              url : href+"/categoria_voip_delete/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
