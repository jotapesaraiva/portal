  ...
  $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            url : server+"/equipamento_voip_list",//json datasource
  ...
  function edit_person(id) {
      ...
      $.ajax({
          url : server+"/equipamento_voip_edit/" + id,
          type: "GET",
          dataType: "JSON",
  ...
  function save(){
      ...
      var url;
      if(save_method == 'add') {
          url = server+"/equipamento_voip_add";
      } else {
          url = server+"/equipamento_voip_update";
      }
  ...
  function delete_person(id){
      if(confirm('Você tem certeza que quer deletar o item?')) {
          ...
          $.ajax({
              url : server+"/equipamento_voip_delete/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data) {
