...
function add_manutencao() {
    ...
    $('#modal_manutencao').modal('show'); // show bootstrap modal
    $('.modal-title').text('Adicionar manutencao'); // Set Title to Bootstrap modal title
}
...
function edit_manutencao(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            $('[name="id"]').val(data.id);
            $('[name="nome"]').val(data.nome_manutencao);
            $('[name="mensagem"]').val(data.mensagem_manutencao);
            $('[name="data_inicio"]').val(data.data_inicio_manutencao);
            $('[name="data_fim"]').val(data.data_fim_manutencao);
            $('[name="grupo"]').selectpicker('val', data.id_grupo);
            $('[name="mantis_solicitado"]').val(data.mantis_solicitado);
            $('[name="mantis"]').val(data.mantis);
            //
            $('#modal_manutencao').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Editar manutencao'); // Set title to Bootstrap modal title
        },
